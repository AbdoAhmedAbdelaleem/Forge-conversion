...
class Writer {
    ...
    constructor(options = {}) {
        ...
        this.meshHashes = []; // List of hashes of existing gltf.Mesh objects, used for deduplication
        this.bufferViewHashes = []; // List of hashes of existing gltf.BufferView objects, used for deduplication
        this.accessorHashes = []; // List of hashes of existing gltf.Accessor objects, used for deduplication
        this.pendingTasks = [];
        this.stats = {
